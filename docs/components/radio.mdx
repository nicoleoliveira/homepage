...
- [Radio Group](/docs/components/radiogroup)
:::
...
:::note API
Para saber a lista de propriedades e eventos, acesse o [guia de referência de API](http://animaliads.io/?path=/docs/api-radio--sample).
:::
