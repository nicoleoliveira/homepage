...
import ButtonAnatomy from './img/button-anatomy.svg';
...
<ani-button>Hello my component</ani-button>
...
<img src={button_states} alt="Os cinco estados do botão primário dispostos lado a lado" />
